...
```{R}
library(tidyverse)
data1a<-read.csv("/content/TB_Lab.csv", header=T)
data1b<-read.csv("/content/TB_pop.csv", header=T)
data2<-read.csv("/content/GDP per capita.csv", header=T)
